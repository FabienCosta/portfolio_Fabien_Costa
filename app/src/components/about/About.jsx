      ...
      <div className="about_main">
        <div className="about_main_description">
          ...
          <p className="about_main_text">
            ...
            Node.js, ce qui me donne une vision globale du développement web. En
            plus de mes compétences techniques, je suis autonome, ouvert
          ...
          <p className="about_main_text">
            ...
            aussi ouvert à un stage pour prouver que je peux être un atout pour
            votre équipe.
          </p>
        </div>
        <div className="about_main_description">
